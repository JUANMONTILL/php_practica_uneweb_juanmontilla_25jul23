<?php
  /*
    ...
    Una clase es un plantilla para objetos y un objeto es una instancia de una clase.
    ...
    Supongamos que tenemos una clase llamada Car. Un automovil puede tener propiedades como modelo, color, etc. Podemos definir variables como $modelo, $color, etc, para contener los valores de estas propiedades.
    ...
    Si creamos una funcion __construct(), PHP llamara automaticamente a esta funcion cuando cree un objeto de un clase.
  */
